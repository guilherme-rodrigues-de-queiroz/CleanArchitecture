...
using CleanArchitecture.Application.UseCases.GetUserById;
...
public class UsersController : ControllerBase
{
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetUserByIdResponse>> Get(Guid id, CancellationToken cancellationToken)
    {
        var response = await _mediator.Send(new GetUserByIdRequest(id), cancellationToken);
